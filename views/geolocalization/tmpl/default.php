...
<div class="form-inline">
	<input id="address" type="text" placeholder="Enter location here to search"> <input
		type="button" value="Seach" onclick="codeAddress()" class="btn">
</div>

<div id="map_canvas" style="width: 520px; height: 500px;"></div>
<div class="form-inline">
