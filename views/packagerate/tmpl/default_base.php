...
?>
	...
	<table style="width:300px">
				...
				<tr>
				  ...
				  <td><input class="input-small required" type="text" name="frate[base][single_sup]" placeholder="<?php echo JText::_('COM_BOOKPRO_TOUR_SINGLE_SUPPLEMENT') ?>" id="promo" maxlength="255" value="" /></td>
				</tr>
